...
const JoinUs = () => {
  return (
    <div
      className={`h-[464px] bg-no-repeat  rounded-[60px] bg-gradient-to-r from-[#000000] w-full relative mb-[170px] z-10`}
    >
      <img
        src={Pic}
      ...
      <div className={`flex  flex-col gap-9 pt-[64px] pl-[64px]`}>
        ...
        <p className={` text-white font-semibold text-xl w-[594px]`}>
          Join us today and let us support you on your professional journey as a
          woman surgeon.
        </p>
